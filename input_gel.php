...
$query = mysqli_query($koneksi,"SELECT * FROM tbl_gel "); 
...
<div class="container-fluid">
  <div class="jumbotron jumbotron-fluid">
    <div class="container d-flex justify-content-between align-items-center">
      <h5>Input Gelombang</h5>
      <a href="gelombang.php"> <button class="btn btn-primary">Tambah Data</button></a>
    </div>
  </div>
  <br>
  <table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td><a class="btn btn-warning" href="editgel.php?id=<?php echo $data['id'] ?>" role="button">ubah</a> | <a class="btn btn-danger" href="hapusgel.php?id=<?php echo $data['id'] ?>" role="button">hapus</a></td>
