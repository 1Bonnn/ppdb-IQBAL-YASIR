...
<div class="container-fluid">
  <div class="jumbotron jumbotron-fluid">
    <div class="container d-flex justify-content-between align-items-center">
      <h5>Registrasi</h5>
      <a href="admin.php"> <button class="btn btn-primary">Tambah Data</button></a>
    </div>
  </div>
  <br>
  <table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td><a class="btn btn-warning" href="editdata.php?id=<?php echo $data['id'] ?>" role="button">Link</a> | <a class="btn btn-danger" href="hapusdata.php?id=<?php echo $data['id'] ?>" role="button">Link</a></td>
